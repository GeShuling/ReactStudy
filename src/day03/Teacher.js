    ...
    return (
      <div>
        ...
        <Form layout="vertical">
          ...
          性别<br/>
          {/* <label><Input type="radio" name="gender" value={form.gender} onChange={this.changeHandler}/>男</label>
          <label><Input type="radio" name="gender" value={form.gender} onChange={this.changeHandler}/>女</label> */}
